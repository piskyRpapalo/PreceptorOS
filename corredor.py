...
Ejecuta las 19 suites (14 unittest + 5 propias), cuenta los tests,
...
SUITES_UNITTEST = [
    ...
    "test_recuperacion.py", "test_silencio.py", "test_voz_cyber.py", "test_frontera.py", "test_andamio.py", "test_fusible.py", "test_identidad.py", "test_costura.py",
]
SUITES_PROPIAS = [
