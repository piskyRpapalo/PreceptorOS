...
Uso:  python3 preceptoros.py [--db RUTA]
      python3 preceptoros.py --view [--db RUTA]     solo mirar
      python3 preceptoros.py --export [--db RUTA]   markdown redactado
      python3 preceptoros.py --backup [FICHERO]     copia entera y comprobada
