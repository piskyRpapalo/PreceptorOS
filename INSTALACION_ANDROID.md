# Instalar PreceptorOS en un teléfono Android
...
| | Estado |
|---|---|
| **Termux** · una línea, y PreceptorOS habla | **funciona hoy** |
...
de inicio → Widgets → Termux → elige *PreceptorOS*. Si Termux:Widget no está, el
...
pantalla de inicio**. Queda un icono que abre PreceptorOS a pantalla completa, sin
...
Toca el icono **PreceptorOS** en la pantalla de inicio. Arranca el servidor y abre
...
Nada pesado llega sin que lo aceptes. En el primer arranque PreceptorOS te ofrece,
...
Lo pedido es una APK que se instale con un clic y abra PreceptorOS. **Un envoltorio
...
pantalla de inicio da, hoy, un PreceptorOS que se abre desde un icono. Lo que falta
