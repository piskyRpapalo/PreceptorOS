#!/usr/bin/env python3
"""R4 · La conversación · el output-guard de alucinación (V-3).

Rojo J: comando destructivo NO listado y categorías de forma real.
Rojo K: benignos gemelos que no deben disparar el output-guard.
...
class TestOutputGuardAlucinacion(unittest.TestCase):
    ...
    def test_rojo_j_destructivo_no_listado(self):
        ...
        res = output_guard.inspeccionar(texto)
